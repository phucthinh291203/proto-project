...
type LoginRequest struct {
	...
	Type     string `protobuf:"bytes,3,opt,name=type,proto3" json:"type,omitempty"` // "Admin" hoặc "Teacher"
}
...
type LoginResponse struct {
	...
	Message string `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"` // Có thể là một lời chào, như "Hello, [name]"
}
